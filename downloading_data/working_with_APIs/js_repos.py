...
# Gráfico de barrar interativo que mostra os projetos de Javacript com mais
# estrelas no GitHub.
...
data = [{
    ...
    'marker': {
        'color': 'rgb(161, 40, 48)',
        'line': {'width': 1.5, 'color': 'rgb(202, 0, 42)'}
    },
    'opacity': 0.6
}]

my_layout = {
    'title': "Projetos de Javascript com mais estrelas no GitHub",
    'titlefont': {'size': 28}, 
    'xaxis': {
        'title': 'Repositório',
        'titlefont': {'size': 24},
